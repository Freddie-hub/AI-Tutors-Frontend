...
const UpskillOverview = () => {
	const features = [
		"Personalized upskilling paths across tech and soft skills.",
		"Bite-sized lessons with practice, projects, and feedback.",
		"AI mentor that adapts to pace, interests, and goals.",
		"Track progress with streaks, XP, mastery, and portfolios.",
		"Real-world tasks to build confidence and outcomes.",
		"Learn anywhere — desktop or mobile optimized."
	];
			...
			<div className="relative min-h-[420px] md:min-h-[380px] p-8 md:p-14">
				...
				<div className="relative z-10 md:w-[55%] space-y-6">
					<h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight">
						Upskill Fast —{" "}
						<span className="text-[#00E18A]">AI-Guided Growth</span>
					</h1>

					<p className="text-base md:text-lg text-gray-300 leading-relaxed">
						Level up your skills with dynamic, adaptive learning pathways.
						Your AI guide calibrates content to your goals and current level
						so you can make steady, meaningful progress.
					</p>
