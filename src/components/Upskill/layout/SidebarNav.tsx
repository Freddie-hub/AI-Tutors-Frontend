...
export default function SidebarNav({ active = 'Dashboard' }: SidebarNavProps) {
  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      id: 'Classroom',
      label: 'Classroom',
      href: '/dashboard/upskill/classroom',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
    ...
    },
    {
      id: 'Courses',
      label: 'Courses',
      href: '/dashboard/upskill/courses',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
    ...
    },
    {
      id: 'Resources',
      label: 'Resources',
      href: '/dashboard/upskill/resources',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
    ...
    },
    {
      ...
      href: '/dashboard/upskill/certifications',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
    ...
    },
    {
      id: 'Schedule',
      label: 'Schedule',
      href: '/dashboard/upskill/schedule',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
    ...
    },
    {
      id: 'Messages',
      label: 'Messages',
      href: '/dashboard/upskill/messages',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
