          ...
          <div className="w-full max-w-md mt-6">
            <div className="bg-[#0E0E10] rounded-lg p-4 border border-white/10">
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2 text-sm text-white/50">
                  <div className="w-2 h-2 rounded-full bg-white/20" />
                  <span>Aligning with GCSE curriculum...</span>
                </div>
              </div>
            </div>
          </div>
    ...
    <>
      <DialogHeader>
        <div className="flex items-center gap-2">
          ...
          <DialogTitle className="text-white/95">Create GCSE Course</DialogTitle>
        </div>
        <p className="text-[#9aa6b2] text-sm mt-2">
          ...
          >
            {curriculum.map((g, idx) => (
              <option key={idx} value={idx} className="bg-[#0E0E10]">
                {g.programme.replace('United Kingdom General Certificate of Secondary Education (GCSE) - ', '')}
              </option>
            ))}
          </select>
        </div>
