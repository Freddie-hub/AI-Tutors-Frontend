...
export default function SidebarNav({ active = 'Dashboard' }: SidebarNavProps) {
  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      id: 'Classroom',
      label: 'Classroom',
      href: '/dashboard/student/gcse/classroom',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
    ...
    },
    {
      id: 'Courses',
      label: 'Courses',
      href: '/dashboard/student/gcse/courses',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
    ...
    },
    {
      id: 'Resources',
      label: 'Resources',
      href: '/dashboard/student/gcse/resources',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
    ...
    },
    {
      ...
      href: '/dashboard/student/gcse/certifications',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
    ...
    },
    {
      id: 'Schedule',
      label: 'Schedule',
      href: '/dashboard/student/gcse/schedule',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
    ...
    },
    {
      id: 'Messages',
      label: 'Messages',
      href: '/dashboard/student/gcse/messages',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
