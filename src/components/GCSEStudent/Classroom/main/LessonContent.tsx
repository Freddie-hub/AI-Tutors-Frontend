...
export default function LessonContent() {
  ...
  // Prepare sanitized and formatted HTML once per content change
  const { formattedHtml, toc } = useMemo(() => {
    ...
    // Build a transient DOM to restructure headings and build a TOC
    const container = document.createElement('div');
    container.innerHTML = safe;

    // Normalize headings structure h2/h3/h4 as Sections / Subsections / Subtopics with numbering
    ...
    // Blockquotes, rules, and code styling
