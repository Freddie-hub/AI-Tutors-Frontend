...
export default function SidebarNav({ active = 'Dashboard' }: SidebarNavProps) {
  ...
  href: '/dashboard/student/institution',
    ...
    },
    {
      id: 'Classroom',
      label: 'Classroom',
  href: '/dashboard/student/institution/classroom',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
    ...
    },
    {
      id: 'Courses',
      label: 'Courses',
  href: '/dashboard/student/institution/courses',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
    ...
    },
    {
      id: 'Resources',
      label: 'Resources',
  href: '/dashboard/student/institution/resources',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
  ...
  href: '/dashboard/student/institution/certifications',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
    ...
    },
    {
      id: 'Schedule',
      label: 'Schedule',
  href: '/dashboard/student/institution/schedule',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
    ...
    },
    {
      id: 'Messages',
      label: 'Messages',
  href: '/dashboard/student/institution/messages',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
